...
bool Ship::collidesWith(const Bullet& bullet) const {
    ...
    std::cout << "Bullet Bounds: (" << bulletBounds.left << ", " << bulletBounds.top
              << ", " << bulletBounds.width << ", " << bulletBounds.height << ")" << std::endl;

    std::cout << "Ship Bounds: (" << shipBounds.left << ", " << shipBounds.top
              << ", " << shipBounds.width << ", " << shipBounds.height << ")" << std::endl;
